...
process memory landed between 0.9 and 1.2 GB across runs. That is the practical limit on how many
large tenants one daemon can hold, and it is the number to watch before any of the latencies above.
